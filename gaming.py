...
def build_app():
    ...
    app.add_handler(CallbackQueryHandler(auction.callback_router, pattern=r"^(auction_host:|auction_table_choice:|auction_table_change:|auction_load:|end_confirm:|min_buy:|max_buy:|time_confirm:)"))
